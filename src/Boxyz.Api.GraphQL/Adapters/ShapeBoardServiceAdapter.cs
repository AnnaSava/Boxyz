...
namespace Boxyz.Proto.Api.GraphQL.Adapters
{
    public class ShapeBoardServiceAdapter
    {
        ...
        public async Task<ILookup<long, ShapeBoardCultureModel>> GetCulturesByBoardId(IEnumerable<long> boardIds, 
        ...
        public async Task<IDictionary<(long, string), ShapeBoardCultureModel>> GetSingleCultures(IEnumerable<(long, string)> keys, 
            CancellationToken cancellationToken)
        {
